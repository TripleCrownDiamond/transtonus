...
class QuoteList extends Component
{
    ...
    {
        // Pour Livewire v3, utilisez dispatch
        $this->dispatch('showQuoteDetails', quoteId: $quoteId);
        
        // Si vous utilisez Livewire v2, utilisez emit à la place
        // $this->emit('showQuoteDetails', $quoteId);
    }
