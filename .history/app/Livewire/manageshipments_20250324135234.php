    ...
    public function saveShipment()
    {
        ...
        try {
            ...
            $shipmentData = [
                ...
                'locale' => $this->locale,
                'additional_info' => $this->additional_info, // Added this field
            ...
            if ($shipment->recipient_email) {
                // Add the Mail facade import at the top of the file if not already there
                // use Illuminate\Support\Facades\Mail;
                // use App\Mail\ShipmentNotification;

                // Fix: Use ShipmentNotification instead of ShipmentUpdated
                Mail::to($shipment->recipient_email)->send(new ShipmentNotification($shipment, $payment ?? null));
            }
