...
class ShipmentNotification extends Mailable
{
    ...
    public function build()
    {
        $subject = $this->isUpdate
            ? __('messages.shipshipment_update_subject', ['tracking' => $this->shipment->tracking_number])
            : __('messages.shipshipment_notification_subject', ['tracking' => $this->shipment->tracking_number]);
