...
class ShipmentNotification extends Mailable
{
    ...
    public function build()
    {
        $subject = $this->isUpdate
            ? __('messages.shipment_update_subject', ['tracking' => $this->shipment->tracking_number])
            : __('messages.shipment_notification_subject', ['tracking' => $this->shipment->tracking_number]);
