...
use App\Http\Controllers\TrackShipment;
...
Route::prefix('{locale}')
    ...
    ->group(function () {
        ...
        Route::post('/track', [TrackShipment::class, 'search'])->name('shipment.search');
        Route::get('/track/{shipment}', [TrackShipment::class, 'track'])->name('shipment.track');
