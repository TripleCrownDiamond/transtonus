...
<div class="bg-gray-100 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 p-4">
    ...
    <!-- Carte : Prises de contact non lues -->
    <div
        class="bg-gradient-to-br from-white to-pink-50 p-3 rounded-lg shadow-sm border border-pink-100 transform transition duration-200 hover:scale-105">
        <div class="flex items-center mb-2">
            <div class="bg-pink-100 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    class="w-4 h-4 stroke-pink-600">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <p class="text-pink-600 font-medium text-lg">
