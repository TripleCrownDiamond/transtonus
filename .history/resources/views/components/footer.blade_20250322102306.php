<footer id="footer" class="footer dark-background">
    <div class="container footer-top">
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                ...
                <p>{{ env('APP_CITY') }}</p>
                <p>{{ env('APP_COUNTRY') }}</p>
                <p class="mt-4"><strong>{{ __('messages.nav.contact') }}:</strong> <span>{{ env('APP_PHONE') }}</span></p>
    ...
    <div class="container copyright text-center mt-4">
        <p>&copy; <span>Copyright</span> <strong>{{ config('app.name', 'Transtonus') }}</strong> <span>{{ __('messages.footer.copyright') }}</span></p>
    </div>
</footer>