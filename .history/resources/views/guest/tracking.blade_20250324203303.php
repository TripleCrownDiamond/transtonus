                    ...
                    <div class="tracking-card">
                        ...
                        <div class="tracking-body">
                            <div class="tracking-info">
                                ...
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.shipment_emails.tracking.recipient') }}</div>
                                    <div class="info-value">{{ $shipment->recipient_name }}</div>
                                </div>
                                
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.shipment_emails.tracking.recipient_email') }}</div>
                                    <div class="info-value">{{ $shipment->recipient_email }}</div>
                                </div>
                                
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.shipment_emails.tracking.sender') }}</div>
