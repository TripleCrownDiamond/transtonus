...
@section('content')
    @include('components.page-title', ['pageTitle' => __('messages.nav.privacy-policy'), 'pageDescription' => __('messages.privacy_content.description')])
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="policy-card">
                        <div class="policy-header">
                            ...
                            <span class="last-updated">{{ __('messages.privacy_content.last_updated') }}: {{ date('d/m/Y', strtotime($lastUpdated)) }}</span>
                        </div>
