                    ...
                    <div class="tracking-card">
                        ...
                        <div class="tracking-body">
                            <div class="tracking-info">
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.shipment_emailstracking_number') }}</div>
                                ...
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.destination') }}</div>
                                    <div class="info-value">{{ $shipment->destination }}</div>
                                </div>
                                
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.current_location') }}</div>
                                    <div class="info-value">{{ $shipment->current_location ?: $shipment->origin }}</div>
                                </div>
                                
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.departure_date') }}</div>
                                    <div class="info-value">{{ $shipment->departure_date->format('d/m/Y') }}</div>
                                </div>
                                
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.estimated_arrival_date') }}</div>
                            ...
                            <div class="payment-details mt-5">
                                <h4 class="section-title">{{ __('messages.payment_details') }}</h4>
                                
                                @php $payment = $shipment->payments->first(); @endphp
                                <div class="info-row">
                                    <div class="info-label">{{ __('messages.amount') }}</div>
