                ...
                <div class="bg-white rounded-lg shadow-sm p-4">
                    ...
                    <div class="mb-4">
                        <label for="searchFilter" class="block text-sm font-medium text-gray-700 mb-1">Rechercher une
                            clé</label>
                        <div class="flex">
                            <input type="text" wire:model.debounce.300ms="searchFilter" id="searchFilter"
                                class="block w-full rounded-l-md border-gray-300 shadow-sm focus:border-[#00A7E1] focus:ring-[#00A7E1] sm:text-sm"
                                placeholder="Filtrer les clés de traduction...">
                            <!-- Remplacez ce bouton: -->

                            <!-- Par celui-ci: -->
                            <button wire:click="resetFilter"
                                class="inline-flex items-center px-4 py-2 border border-transparent rounded-r-md font-semibold text-white bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
