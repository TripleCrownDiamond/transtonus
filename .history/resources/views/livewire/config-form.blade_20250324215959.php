    ...
    <div class="bg-gray-100 p-4">
        <form wire:submit.prevent="submit">
            ...
            <div class="mb-6 bg-white p-4 rounded-lg shadow">
                ...
                <div class="mb-4">
                    <label for="app_company_legal_name" class="block text-sm font-medium text-gray-700">Nom légal de
                        l'entreprise</label>
                ...
                <div class="mb-4">
                    <label for="app_company_registration_number"
                        class="block text-sm font-medium text-gray-700">Numéro d'immatriculation</label>
                    <input type="text" wire:model.defer="app_company_registration_number"
                        id="app_company_registration_number"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#00A7E1] focus:ring-[#00A7E1] sm:text-sm">
                ...
                <!-- Champ : Numéro de TVA -->
                <div class="mb-4">
                    <label for="app_company_tax_id" class="block text-sm font-medium text-gray-700">Numéro de
                        TVA</label>
                ...
                <div class="mb-4">
                    <label for="app_company_founded" class="block text-sm font-medium text-gray-700">Année de
                        fondation</label>
                ...
                <div class="mb-4">
                    <label for="app_legal_contact_email" class="block text-sm font-medium text-gray-700">Email de
                        contact légal</label>
                ...
                <div class="mb-4">
                    <label for="app_privacy_last_updated" class="block text-sm font-medium text-gray-700">Date de mise
                        à jour de la politique de confidentialité</label>
                ...
                <div class="mb-4">
                    <label for="app_terms_last_updated" class="block text-sm font-medium text-gray-700">Date de mise à
                        jour des conditions d'utilisation</label>
                ...
                <!-- Champ : Juridiction -->
                <div class="mb-4">
                    <label for="app_company_jurisdiction"
                        class="block text-sm font-medium text-gray-700">Juridiction</label>
            ...
            <div class="mb-6 bg-white p-4 rounded-lg shadow">
                ...
                <!-- Champ : Instagram -->
                <div class="mb-4">
                    <label for="app_social_instagram"
