                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        ...
                        <button wire:click="resetFilter"
                            class="inline-flex items-center px-4 py-2 border border-transparent rounded-r-md font-semibold text-white {{ empty($searchFilter) ? 'bg-gray-400' : 'bg-gray-700 hover:bg-gray-800' }} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
