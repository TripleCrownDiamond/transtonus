                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                @else
                                    ...
                                    <button wire:click="editShipment({{ $shipment->id }})" 
                                            wire:loading.attr="disabled"
                                            wire:target="editShipment({{ $shipment->id }})"
                                            class="text-blue-600 hover:text-blue-900 mr-3 relative">
                                        ...
                                        <svg wire:loading wire:target="editShipment({{ $shipment->id }})" 
                                             xmlns="http://www.w3.org/2000/svg" class="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
