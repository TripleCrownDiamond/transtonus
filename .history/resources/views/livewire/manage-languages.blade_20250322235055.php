                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        ...
                        <button wire:click="resetFilter"
                            class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-r-md font-semibold {{ empty($searchFilter) ? 'text-gray-500 bg-gray-200' : 'text-white bg-gray-700 hover:bg-gray-800' }} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                            {{ empty($searchFilter) ? 'disabled' : '' }}>
