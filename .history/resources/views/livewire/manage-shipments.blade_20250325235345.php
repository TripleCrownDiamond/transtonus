                ...
                <form wire:submit.prevent="saveShipment">
                    ...
                    <div x-show="activeTab === 'shipment'">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-4" x-data="{ showPreview: false, formattedText: '' }">
...
- Autres informations utiles"></textarea>
                                    <button type="button" @click="showPreview = !showPreview"
                                        class="absolute right-2 bottom-2 px-2 py-1 bg-gray-200 text-gray-700 text-xs rounded hover:bg-gray-300 transition-colors duration-150">
                                ...
                                <div x-show="showPreview" x-cloak class="mt-2 p-3 border rounded-md bg-gray-50">
                                    <h4 class="text-sm font-medium text-gray-700 mb-1">Aperçu:</h4>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Options de formatage: <br>
                                    - Utilisez *texte* pour <em>italique</em><br>
                                    - Utilisez **texte** pour <strong>gras</strong><br>
                                    - Utilisez _texte_ pour <u>souligner</u><br>
                                    - Utilisez ## Texte pour <span class="font-bold">titre niveau 2</span><br>
                                    - Utilisez ### Texte pour <span class="font-bold">titre niveau 3</span><br>
                                    - Utilisez - Texte pour liste à puces<br>
                                    - Utilisez 1. Texte pour liste numérotée<br>
                                    - Utilisez [color:red]texte coloré[/color] pour <span class="text-red-500">texte
                                        coloré</span><br>
                                    - Utilisez [link:https://exemple.com]texte du lien[/link] pour <a href="#"
                                        class="text-blue-600 hover:underline">texte du lien</a><br>
