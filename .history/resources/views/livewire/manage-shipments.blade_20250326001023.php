                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute right-2 bottom-2 flex space-x-2">
                                        <button type="button" @click="showPreview =!showPreview"
                                            class="px-2 py-1 bg-gray-200 text-gray-700 text-xs rounded hover:bg-gray-300 transition-colors duration-150"></textarea>
                                            <div class="absolute right-2 bottom-2 flex space-x-2">
                                                <button type="button" @click="showPreview = !showPreview"
                                                    class="px-2 py-1 bg-gray-200 text-gray-700 text-xs rounded hover:bg-gray-300 transition-colors duration-150">
                                                    <span
                                                        x-text="showPreview ? 'Masquer l\'aperçu' : 'Voir l\'aperçu'"></span>
                                                </button>
                                            </div>
                                    </div>
                        ...
                        <div x-show="activeTab === 'payment'">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <label for="payment_method"
                                        class="block text-sm font-medium text-gray-700 mb-1">Méthode de
                                        paiement</label>
                            ...
                            <div class="mb-4">
                                <label for="instructions"
                                    class="block text-sm font-medium text-gray-700 mb-1">Instructions de
                                    paiement</label>
                                <textarea id="instructions" wire:model="instructions" rows="3"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#5E0035] focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    placeholder="Instructions spécifiques pour le paiement (IBAN, Western Union, PayPal, virement bancaire, etc.)..."></textarea>
