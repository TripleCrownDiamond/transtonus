<div>
    <!-- Afficher un message de succès ou d'erreur via session -->
    ...
    <div id="notification-container" class="mb-4" style="display: none;">
        <div id="notification-box" class="border px-4 py-3 rounded relative" role="alert">
            <strong class="font-bold" id="notification-title"></strong>
                            ...
                            <div class="p-4 bg-white rounded-lg shadow-sm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="text-sm text-gray-500 mb-2">
                                        <span class="font-medium">Valeur actuelle :</span> 
                                        {{ isset($translations[$key]) && !empty($translations[$key]) ? $translations[$key] : 'Non défini' }}
                                    </div>
                                    
                                    <!-- Traduction française pour référence -->
...
<!-- Script pour gérer les notifications sans rechargement -->
<script>
    document.addEventListener('livewire:initialized', () => {
        @this.on('notify', (data) => {
            ...
            if (data.type === 'success') {
                box.className = 'bg-green-100 border-green-400 text-green-700 border px-4 py-3 rounded relative';
                title.textContent = 'Succès! ';
            } else {
                box.className = 'bg-red-100 border-red-400 text-red-700 border px-4 py-3 rounded relative';
