...
<div class="bg-gray-100 p-4">
    <form action="{{ route('configs.update') }}" method="POST">
        ...
        <div class="flex justify-end">
            <button type="submit"
                class="inline-flex items-center px-4 py-2 bg-[#00A7E1] border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00A7E1]">
                Enregistrer
            </button>
        </div>
    </form>
