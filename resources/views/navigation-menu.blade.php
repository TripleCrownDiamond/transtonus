<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('quote-request') }}" :active="request()->routeIs('quote-request')">
                        Demandes de devis
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('configs') }}" :active="request()->routeIs('configs')">
                Configurations
            </x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('languages') }}" :active="request()->routeIs('languages')">
                Langues
            </x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('quote-request') }}" :active="request()->routeIs('quote-request')">
                Demandes de devis
            </x-responsive-nav-link>
